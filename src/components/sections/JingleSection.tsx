        ...
        <div className="lg:col-span-4">
          ...
          <div className="mt-8 flex max-w-xs flex-col gap-3">
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-[#FBE502] px-5 py-3 font-archivo text-sm font-black uppercase tracking-wide text-[#003967] transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1256CE] focus-visible:ring-offset-2"
            >
              ASSISTA AO JINGLE
            ...
            <button
              ...
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-lg bg-[#93FD04] px-5 py-3 font-archivo text-sm font-black uppercase tracking-wide text-[#003967] transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1256CE] focus-visible:ring-offset-2"
            >
              COMPARTILHAR NO ZAP
              <ArrowUpRight className="h-4 w-4" aria-hidden="true" />
            </button>
